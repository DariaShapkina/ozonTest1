...
public class WebMain {
    ...
    public WebMain(WebDriver driver, WebDriverWait webDriverWait) {
        this.driver = driver;
    ...
    public void inputPhoneNum() {
        ...
        phoneInput.sendKeys(Settings.PHONE);
    ...
    public void inputCode() {
        ...
        codeInput.sendKeys(Settings.AUTH_CODE);
    }

    @Step("Соответствие значений")
    public void checkSettings() {
        ...
        assertEquals(settings.getAttribute("href"), Settings.OZON_URL + "/my/main");
    }
}
